 ...
 */
public class Feasibility_photo1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appLocationService = new AppLocationService(
         Feasibility_photo1.this);
        sessionManager=new SessionManager(Feasibility_photo1.this);
        sqLiteMasterTableAdapter=new SQLiteMasterTableAdapter(Feasibility_photo1.this);
        connectionDetector=new ConnectionDetector(Feasibility_photo1.this);

        sqLiteAdapter=new SQLiteAdapter(Feasibility_photo1.this);
       ...
       if(TextUtils.isEmpty(consumer_photo)) {
        ...
        if(TextUtils.isEmpty(aadhar_photo)) {
           ...
           /* aadhar_btn.setVisibility(View.INVISIBLE);
            ...
            ed_aadhar.setBackgroundColor(Color.YELLOW);
        }
        ...
        if(TextUtils.isEmpty(address_photo)) {
            ...
            ed_address_id.setBackgroundColor(Color.YELLOW);
            spinner_address.setBackgroundColor(Color.YELLOW);
        }
        ...
        if(TextUtils.isEmpty(land_photo)) {
           ...
           /* land_btn.setVisibility(View.INVISIBLE);
            ...
            spinner_land.setBackgroundColor(Color.YELLOW);
        }
        ...
        if(TextUtils.isEmpty(nodues_photo)) {
            ...
            no_dues_btn.setBackgroundColor(Color.YELLOW);
        ...
        consumer_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //c_name= DataHolderClass.getInstance().getConsumer_image_name();
                    ...
                    startActivity(new Intent(Feasibility_photo1.this, ConsumerImage.class));
                     finish();
        ...
        land_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(spinner_land.getSelectedItem().toString().trim().equals("Select Land/Rent Type")){
                    ...
                    startActivity(new Intent(Feasibility_photo1.this, LandImage.class));
                    finish();
                }
        ...
        address_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(spinner_address.getSelectedItem().toString().trim().equals("Select Address Proof") ||  TextUtils.isEmpty(str_address_id)){
                    ...
                    startActivity(new Intent(Feasibility_photo1.this, AddressImage.class));
                    finish();
                }
        ...
        aadhar_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(str_ed_aadhar_no) || str_ed_aadhar_no.length()!=12){
                    ...
                    startActivity(new Intent(Feasibility_photo1.this, AadharImage.class));
                    finish();
        ...
        no_dues_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Feasibility_photo1.this, NoDuesImage.class));
                finish();
    ...
    public void ShowAlertonBack(){
        Feasibility_photo1.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(Feasibility_photo1.this);
                builder.setCancelable(false);
                builder.setTitle("Are you sure to go back:");
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(Feasibility_photo1.this, Feasibility.class));
                        finish();
    ...
    {
        consumer_btn=(Button)findViewById(R.id.consumer_btn);
        ...
        ed_address_id=(EditText)findViewById(R.id.ed_address);
        spinner_address=(Spinner)findViewById(R.id.tv_address);
        spinner_land=(Spinner)findViewById(R.id.tv_land_rent);

        no_dues_btn=(Button)findViewById(R.id.dues_btn);
        ...
        alertDialog.setPositiveButton("Settings",
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Feasibility_photo1.this.startActivity(intent);
                    }
                });
...
public class SendFeasibility extends AsyncTask<String, String,String>
{
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        pd=new ProgressDialog(Feasibility_photo1.this);
        ...
        try {
            if(network_interrupt==null) {
                ...
                if (response.equalsIgnoreCase("1")) {
                    ...
                    startActivity(new Intent(Feasibility_photo1.this, Options.class));
                    finish();
                } else {
                    ShowAlert();
