...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("landrecord_type",DataHolderClass.getInstance().getLand_record_type()));
            nameValuePairs.add(new BasicNameValuePair("lndimge_name",meterimageName));
