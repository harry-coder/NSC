...
public class Feasibility extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        trnfer_cap=(TextView)findViewById(R.id.view_transformer_capa);
        trnsfer_code=(TextView)findViewById(R.id.view_transformer_code);
        poleno=(TextView)findViewById(R.id.view_pole_no);
        loan=(TextView)findViewById(R.id.tv_ds_tariff);
        consumerno=(TextView)findViewById(R.id.et_ncon_no);
        adj_mru=(TextView)findViewById(R.id.tv_nmru_no);
        wrt_status=(TextView)findViewById(R.id.tv_wiring_status);
        spinner_tarrif_name=(Spinner)findViewById(R.id.spinner_tarrif_name);
        ...
        ed_spinner_load_ds.setEnabled(false);
...
//        spinner_ndsb.setVisibility(View.GONE);
        ...
        ed_spinner_load_ds=(EditText)findViewById(R.id.ed_spinner_load_ds);
