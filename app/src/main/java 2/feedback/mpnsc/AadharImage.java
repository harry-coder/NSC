...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("aadhar_no",DataHolderClass.getInstance().getStr_aadhar_no()));
            nameValuePairs.add(new BasicNameValuePair("aadimage_name",DataHolderClass.getInstance().getAadhar_image_name()));
