...
public class AddressImage extends Activity {
    ...
    private boolean isDeviceSupportCamera() {
        if (AddressImage.this.getPackageManager ( ).hasSystemFeature (
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView ( R.layout.addressimage );
        connectionDetector = new ConnectionDetector ( this );
        sessionManager = new SessionManager ( AddressImage.this );
        sqLiteMasterTableAdapter = new SQLiteMasterTableAdapter ( AddressImage.this );
        sqLiteMultipleTicketList = new MultipleTicketManager ( AddressImage.this );
        ...
        btn_submit.setOnClickListener ( new OnClickListener ( ) {
            ...
            public void onClick(View view) {
                ...
                DataHolderClass.getInstance ( ).setAddress_image ( image );
                DataHolderClass.getInstance ( ).setAddress_image_name ( meterimageName );
            ...
            case CAMERA_CAPTURE_IMAGE_REQUEST_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText ( AddressImage.this,
                                "Err:463" + "\n" + "Image cancelled",
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public void show_ticket(String ticketNumber) {
        AddressImage.this.runOnUiThread ( new Runnable ( ) {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder ( AddressImage.this, R.style.MyAlertDialogStyle );
            ...
            public void run() {
                ...
                builder.setPositiveButton ( "YES", new DialogInterface.OnClickListener ( ) {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent ( AddressImage.this, Feasibility_photo.class );
                        intent.setFlags ( Intent.FLAG_ACTIVITY_CLEAR_TOP );
                        startActivity ( intent );


                        finish ( );
                        // startActivity(new Intent(AddressImage.this, Feasibility_photo.class));
                        //finish();
    ...
    public class SendToServer extends AsyncTask <String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute ( );
            pd = new ProgressDialog ( AddressImage.this, R.style.MyAlertDialogStyle );
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add ( new BasicNameValuePair ( "tag", "set_address" ) );
            nameValuePairs.add ( new BasicNameValuePair ( "TicketNumber", DataHolderClass.getInstance ( ).getTicket_no ( ) ) );
            nameValuePairs.add ( new BasicNameValuePair ( "Address_proof", DataHolderClass.getInstance ( ).getStr_spinner_address_proof ( ) ) );
            nameValuePairs.add ( new BasicNameValuePair ( "Address_proof_details", DataHolderClass.getInstance ( ).getAdress_proof_name_input ( ) ) );
            nameValuePairs.add ( new BasicNameValuePair ( "address_photoname", meterimageName ) );
            nameValuePairs.add ( new BasicNameValuePair ( "addimage", image ) );
            Log.e ( "namevaluepair", "" + nameValuePairs );
            try {
                HttpClient httpclient = new DefaultHttpClient ( );

                //     HttpPost httppost = new HttpPost(sessionManager.GET_URL());
                HttpPost httppost = new HttpPost ( "http://wcrm.fedco.co.in/phedapi/nscapi/setaddress" );
