...
public class NoDuesImage extends Activity {
    ...
    private boolean isDeviceSupportCamera() {
        if (NoDuesImage.this.getPackageManager().hasSystemFeature(
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.noduesimage);
        connectionDetector = new ConnectionDetector(this);
        sessionManager = new SessionManager(NoDuesImage.this);
        sqLiteMasterTableAdapter = new SQLiteMasterTableAdapter(NoDuesImage.this);
        sqLiteMultipleTicketList = new MultipleTicketManager(NoDuesImage.this);
        ...
        btn_submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataHolderClass.getInstance().setNodues_image(image);
                DataHolderClass.getInstance().setNodues_image_name(meterimageName);
            ...
            case CAMERA_CAPTURE_IMAGE_REQUEST_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText(NoDuesImage.this,
                                "Err:463" + "\n" + "Image cancelled",
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public void show_ticket(String ticketNumber) {
        NoDuesImage.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(NoDuesImage.this,R.style.MyAlertDialogStyle);
            ...
            public void run() {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent ( NoDuesImage.this, Feasibility_photo.class );
                     ...
                     //   startActivity(new Intent(NoDuesImage.this, Feasibility_photo.class));
                        //finish();
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(NoDuesImage.this,R.style.MyAlertDialogStyle);
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("tag","set_no_dues"));
            nameValuePairs.add(new BasicNameValuePair("TicketNumber",DataHolderClass.getInstance().getTicket_no()));
            nameValuePairs.add(new BasicNameValuePair("declaration_image_name",meterimageName));
...
//                HttpPost httppost = new HttpPost(sessionManager.GET_URL());
                ...
                HttpPost httppost = new HttpPost ( "http://wcrm.fedco.co.in/phedapi/nscapi/set_no_dues" );
