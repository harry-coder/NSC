...
public class LandImage extends Activity {
    ...
    private boolean isDeviceSupportCamera() {
        if (LandImage.this.getPackageManager().hasSystemFeature(
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.landimage);
        connectionDetector = new ConnectionDetector(this);
        sessionManager = new SessionManager(LandImage.this);
        sqLiteMasterTableAdapter = new SQLiteMasterTableAdapter(LandImage.this);
        sqLiteMultipleTicketList = new MultipleTicketManager(LandImage.this);
        ...
        btn_submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataHolderClass.getInstance().setLand_image(image);
                DataHolderClass.getInstance().setLand_image_name(meterimageName);
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public void show_ticket(String ticketNumber) {
        LandImage.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(LandImage.this,R.style.MyAlertDialogStyle);
            ...
            public void run() {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        Intent intent = new Intent ( LandImage.this, Feasibility_photo.class );
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(LandImage.this,R.style.MyAlertDialogStyle);
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("tag","set_land"));
            nameValuePairs.add(new BasicNameValuePair("TicketNumber",DataHolderClass.getInstance().getTicket_no()));
            nameValuePairs.add(new BasicNameValuePair("LandRecordType",DataHolderClass.getInstance().getLand_record_type()));
            nameValuePairs.add(new BasicNameValuePair("land_photoname",meterimageName));
            nameValuePairs.add(new BasicNameValuePair("lndimg",image));
            ...
            try
            {
               ...
               // HttpPost httppost = new HttpPost(sessionManager.GET_URL());
                ...
                HttpPost httppost = new HttpPost ( "http://wcrm.fedco.co.in/phedapi/nscapi/set_land" );
