...
*/
                Intent intent_existing=new Intent(Options.this, Existing_tab1.class);
               //Intent intent_existing=new Intent(Options.this, MeterImage.class);
                startActivity(intent_existing);
        ...
        //For creating feasibility
        btn_feasibility.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                Intent intent_existing=new Intent(Options.this, Existing_tab1.class);
                intent_existing.putExtra ( "feasibility","technicalFeasibility" );
                //Intent intent_existing=new Intent(Options.this, MeterImage.class);
                startActivity(intent_existing);
    ...
    //Function to take runtime permissions...
    public boolean runTimePermission() {
        if (Build.VERSION.SDK_INT >= 23 && ContextCompat.checkSelfPermission ( this, android.Manifest.permission.ACCESS_COARSE_LOCATION ) != PackageManager.PERMISSION_GRANTED
            ...
            requestPermissions ( new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION, android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.CAMERA, android.Manifest.permission.READ_EXTERNAL_STORAGE, android.Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_PHONE_STATE}, PERMISSION_CODE );
