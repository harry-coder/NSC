...
public class Existing_DataFinish extends Activity {
    ...
    String div_code,Sub_div_code,sec_code;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Sub_div_code=getIntent ().getStringExtra ( "sub_div_code" );
        sec_code=getIntent ().getStringExtra ( "sec_code" );

        System.out.println ("This is is tha fdiv "+div_code );
        System.out.println ("This is is tha fsub "+Sub_div_code );
        System.out.println ("This is is tha fsec "+sec_code );
        ...
        protected String doInBackground(String... params)
        {
            try{
               ...
               // nameValuePairs.add(new BasicNameValuePair("tag",  "update_consumer"));
                ...
                nameValuePairs.add(new BasicNameValuePair("TicketNumber",  DataHolderClass.getInstance().get_ticket_no()));

               /* nameValuePairs.add(new BasicNameValuePair("Div_code", DataHolderClass.getInstance().get_division()));
                nameValuePairs.add(new BasicNameValuePair("Sub_div_code", DataHolderClass.getInstance().get_subdivion()));
                nameValuePairs.add(new BasicNameValuePair("sec_code", DataHolderClass.getInstance().get_section()));
*/

                nameValuePairs.add(new BasicNameValuePair("Div_code", div_code));
                nameValuePairs.add(new BasicNameValuePair("Sub_div_code", Sub_div_code));
                ...
                nameValuePairs.add(new BasicNameValuePair("NewFirstName", DataHolderClass.getInstance().get_name()));
                ...
                nameValuePairs.add(new BasicNameValuePair("FatherName", DataHolderClass.getInstance().get_father_name()));
                ...
                nameValuePairs.add(new BasicNameValuePair("Address1", DataHolderClass.getInstance().getStr_adres1()));
                nameValuePairs.add(new BasicNameValuePair("PIN", DataHolderClass.getInstance().get_pin_no()));
                nameValuePairs.add(new BasicNameValuePair("Address2", DataHolderClass.getInstance().getLandmark()));
                ...
                nameValuePairs.add(new BasicNameValuePair("Mobile_number",DataHolderClass.getInstance().get_mobile()));
