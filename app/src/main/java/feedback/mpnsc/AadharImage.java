...
public class AadharImage extends Activity {
    ...
    private boolean isDeviceSupportCamera() {
        if (AadharImage.this.getPackageManager().hasSystemFeature(
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.aadharimage);
        connectionDetector = new ConnectionDetector(this);
        sessionManager = new SessionManager(AadharImage.this);
        sqLiteMasterTableAdapter = new SQLiteMasterTableAdapter(AadharImage.this);
        sqLiteMultipleTicketList = new MultipleTicketManager(AadharImage.this);
        ...
        btn_submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataHolderClass.getInstance().setAadhar_image(image);
                DataHolderClass.getInstance().setAadhar_image_name(meterimageName);
                ...
                //startActivity(new Intent(AadharImage.this, Feasibility_photo.class));
            ...
            case CAMERA_CAPTURE_IMAGE_REQUEST_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText(AadharImage.this,
                                "Err:463" + "\n" + "Image cancelled",
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public void show_ticket(String ticketNumber) {
        AadharImage.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(AadharImage.this,R.style.MyAlertDialogStyle);
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(AadharImage.this,R.style.MyAlertDialogStyle);
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("tag","set_aadhar"));
            nameValuePairs.add(new BasicNameValuePair("TicketNumber",DataHolderClass.getInstance().getTicket_no()));
            nameValuePairs.add(new BasicNameValuePair("Adhar_number",DataHolderClass.getInstance().getStr_aadhar_no()));
            nameValuePairs.add(new BasicNameValuePair("adhar_photoname",DataHolderClass.getInstance().getAadhar_image_name()));
            nameValuePairs.add(new BasicNameValuePair("aadimage",DataHolderClass.getInstance().getAadhar_image()));
...
//                HttpPost httppost = new HttpPost(sessionManager.GET_URL());
                ...
                HttpPost httppost = new HttpPost ( "http://wcrm.fedco.co.in/phedapi/nscapi/setaadhar" );
    ...
    public void ShowAlert() {
        AadharImage.this.runOnUiThread(new Runnable() {
            public void run() {
                ...
                builder.setNegativeButton(" Record Not Send", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        sqLiteMasterTableAdapter.close();*/
                        Toast.makeText(getApplicationContext(),"Record Not Send", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
                AlertDialog alert = builder.create();
