...
public class MeterImage extends Activity {
    ...
    public void ShowAlertonBack() {
        MeterImage.this.runOnUiThread ( new Runnable ( ) {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder ( MeterImage.this, R.style.MyAlertDialogStyle );
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    {    String network_interrupt=null;
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("meter_inst_date",DataHolderClass.getInstance().getStr_date()));
