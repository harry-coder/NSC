...
public class MeterInstImage extends Activity {
    ...
    private boolean isDeviceSupportCamera() {
        if (MeterInstImage.this.getPackageManager().hasSystemFeature(
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meterinstimage);
        connectionDetector = new ConnectionDetector(this);
        sessionManager = new SessionManager(MeterInstImage.this);
        sqLiteMasterTableAdapter = new SQLiteMasterTableAdapter(MeterInstImage.this);
        sqLiteMultipleTicketList = new MultipleTicketManager(MeterInstImage.this);
        ...
        btn_submit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DataHolderClass.getInstance().setStr_meterinsimageName(meterimageName);
                DataHolderClass.getInstance().setStr_meterinsimage(image);


               startActivity(new Intent(MeterInstImage.this, MeterDetail.class));
                finish();
            ...
            case CAMERA_CAPTURE_IMAGE_REQUEST_CODE:
                switch (resultCode) {
                    ...
                    case Activity.RESULT_CANCELED:
                        Toast.makeText(MeterInstImage.this,
                                "Err:463" + "\n" + "Image cancelled",
...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public void show_ticket(String ticketNumber) {
        MeterInstImage.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(MeterInstImage.this);
        ...
        MeterInstImage.this.runOnUiThread(new Runnable() {
            public void run() {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(MeterInstImage.this, Feasibility_photo.class));
                        //finish();
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            // TODO Auto-generated method stub
            super.onPreExecute();
            pd = new ProgressDialog(MeterInstImage.this);
