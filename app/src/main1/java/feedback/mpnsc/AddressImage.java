...
//                Log.e("IMAGE",""+String.valueOf(byteArray));
    ...
    public class SendToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            nameValuePairs.add(new BasicNameValuePair("address_proof_input",DataHolderClass.getInstance().getAdress_proof_name_input()));
            nameValuePairs.add(new BasicNameValuePair("addimage_name",meterimageName));
