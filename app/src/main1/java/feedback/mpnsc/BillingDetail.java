 ...
 */
public class BillingDetail extends Activity {
   ...
   /* @Override
    ...
    public void ShowAlertonBack(){
        BillingDetail.this.runOnUiThread(new Runnable() {
            public void run() {
                AlertDialog.Builder builder = new AlertDialog.Builder(BillingDetail.this);
                builder.setTitle("Are you sure to go back:");
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        startActivity(new Intent(BillingDetail.this, ExistingConsumer_Search.class));
                        finish();
                    }
                });
